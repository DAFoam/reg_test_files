...
corners[0,1,:] = [-0.01,-0.01,.06]
corners[0,2,:] = [-0.01,0.12, -0.01]
corners[0,3,:] = [-0.01,0.12,.06]
corners[0,4,:] = [1.01,-.01, -0.01]
corners[0,5,:] = [1.01,-.01,.06]
corners[0,6,:] = [1.01,.12, -0.01]
corners[0,7,:] = [1.01,.12,.06]
